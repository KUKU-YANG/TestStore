...
<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=userLogin" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input name="username" type="text" class="form-control" id="username" placeholder="请输入用户名" value="${cookie.remembermeCookie.value }"><span id="s1"></span>
    </div>
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
    <input id="logBut" type="submit"  width="100" value="登录" name="submit" border="0"
