		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<form id="myForm" action="${pageContext.request.contextPath}/CartServlet?method=addCartItem" method="post">
...
<script type="text/javascript">
	$(function() {
		$("#btnId").click(function() {
			...
			//实现同一个表单，不同按钮提交到不同路径
			//不设置则提交默认from标签的action和method
			//formObj.action="/store01/CartServlet";
			//formObj.method="post";
			formObj.submit();
		});
	});
