							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<td width="7%" align="center">
										...
										<!-- varStatus:代表循环过程在临时存储的状态值		status.count：当前输出元素个数 -->
									<c:forEach items="${allCats }" var="cats" varStatus="status">			
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/AdminCategoryServlet?method=editUI&cid=${cats.cid}">
													<img src="${pageContext.request.contextPath}/img/admin/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/AdminCategoryServlet?method=delete&cid=${cats.cid}" onclick="return confirm('确定要删除吗？');">
