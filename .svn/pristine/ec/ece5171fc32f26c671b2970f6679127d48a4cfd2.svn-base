...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<%--分页显示的开始 --%>
    	<div style="text-align:center">
    		...
    		<!-- <a href="/store01/ProductServlet?method=findProductsByCidWithPage&cid=1&num=1">首页</a> -->
    		<!-- <a href="/store01/OrderServlet?method=findMyOrdersWithPage&num=1">首页</a> -->
    		<!-- <a href="/store01/AdminProductServlet?method=findAllProductsWithPage&num=1">首页</a> -->
    		<!-- <a href="/store01/AdminOrderServlet?method=findAllOrdersWithPage&num=1">首页</a> -->
